...
export TRANSFORMERS_CACHE="/scratch/aae15163zd/cache/huggingface/models"
  ...
  #--model_name_or_path /scratch/aae15163zd/outputs/qg/squad-con-paren-ep30/checkpoint-2960/

python_cmd="run_question_generation.py
  --report_to wandb
  --run_name qg-squad-large-v1_1-baseline-noaccum
  --model_name_or_path google-t5/t5-small
  --source_prefix ''
  --lm_type seq2seq
  --dataset_path ~/grp/inputs/squad-parsed-baseline
  --text_column answer_context
  ...
  --output_dir /scratch/aae15163zd/outputs/qg/foo
